...
//
// Compile with CMake (add to c-api-examples/CMakeLists.txt):
//   add_executable(test_seaco_c_api test_seaco_c_api.c)
//   target_link_libraries(test_seaco_c_api sherpa-onnx-c-api)
