...
echo "================================"
echo "升级 onnxruntime 到 1.23.2（使用镜像）"
echo "================================"
echo ""

PROJECT_DIR="/Users/thinkre/Desktop/projects/KeVoiceInput"
# 使用 huggingface 镜像（更快）
DOWNLOAD_URL="https://hf-mirror.com/csukuangfj/onnxruntime-libs/resolve/main/1.23.2/onnxruntime-osx-universal2-1.23.2.tgz"
...
if [ ! -f "$DOWNLOAD_FILE" ]; then
    echo "步骤 1/6: 从 Hugging Face 镜像下载 onnxruntime 1.23.2..."
