...
pub(crate) fn safe_default_offline_model_config(empty: *const std::os::raw::c_char) -> sherpa_rs_sys::SherpaOnnxOfflineModelConfig {
    unsafe {
        sherpa_rs_sys::SherpaOnnxOfflineModelConfig {
            ...
            moonshine: sherpa_rs_sys::SherpaOnnxOfflineMoonshineModelConfig { preprocessor: empty, encoder: empty, uncached_decoder: empty, cached_decoder: empty, merged_decoder: empty },
            ...
            funasr_nano: sherpa_rs_sys::SherpaOnnxOfflineFunASRNanoModelConfig { encoder_adaptor: empty, llm: empty, embedding: empty, tokenizer: empty, system_prompt: empty, user_prompt: empty, max_new_tokens: 0, temperature: 0.0, top_p: 0.0, seed: 0, language: empty, itn: 0, hotwords: empty },
            ...
            fire_red_asr_ctc: sherpa_rs_sys::SherpaOnnxOfflineFireRedAsrCtcModelConfig { model: empty },
        }
    }
}
