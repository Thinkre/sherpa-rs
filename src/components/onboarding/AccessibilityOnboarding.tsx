...
import VoiceInputLogo from "../icons/VoiceInputLogo";
...
if (currentPlatform === "macos") {
  import("tauri-plugin-macos-permissions-api").then((mod) => {
    ...
    checkMicrophonePermission = mod.checkMicrophonePermission;
    requestMicrophonePermission = mod.requestMicrophonePermission;
  });
}
...
const AccessibilityOnboarding: React.FC<AccessibilityOnboardingProps> = ({
  ...
  useEffect(() => {
    ...
    const checkInitial = async () => {
      try {
        if (!checkAccessibilityPermission || !checkMicrophonePermission) {
