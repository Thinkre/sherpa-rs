...
export const HandyShortcut: React.FC<HandyShortcutProps> = ({
  ...
  useEffect(() => {
    ...
    const handleKeyDown = async (e: KeyboardEvent) => {
      ...
      if (isInputField) {
        // Allow normal keyboard input in input fields (including Ctrl+V / Cmd+V)
        return;
      }
    ...
    const handleKeyUp = async (e: KeyboardEvent) => {
      ...
      if (isInputField) {
        // Allow normal keyboard input in input fields
        return;
      }
    ...
    // Use bubble phase (not capture) to allow input fields to handle events first
